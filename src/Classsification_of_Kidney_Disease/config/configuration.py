...
from Classsification_of_Kidney_Disease.entity.config_entity import DataIngestionConfig, PrepareBaseModelConfig
from Classsification_of_Kidney_Disease.entity.config_entity import TrainingConfig, EvaluationConfig
import os
